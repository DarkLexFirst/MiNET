...
namespace MiNET.Client
{
	public class Startup
	{
		...
		static void Main(string[] args)
		{
			...
			//var client = new MiNetClient(new IPEndPoint(IPAddress.Parse("192.168.0.105"), 19132), "TheGrey", new DedicatedThreadPool(new DedicatedThreadPoolSettings(Environment.ProcessorCount)));
